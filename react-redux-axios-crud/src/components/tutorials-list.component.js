...
class TutorialsList extends Component {
  ...
  removeTutorial(orderNo) {
    console.log(orderNo)
    /*
    this.props
      .deleteTutorial(orderNo)
      .then((response) => {
        console.log(response);
        this.refreshData();
      })
    ...
    return (
      <div className="list row">
        ...
        <div className="col-md-6">
          ...
          <button type="button" className="btn btn-danger" onClick={removeTutorial('gfgfggfgfgfg')}>delete</button>
